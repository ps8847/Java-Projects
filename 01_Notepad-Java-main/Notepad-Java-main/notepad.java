import java.io.*;
 ...
 public class notepad extends JFrame implements ActionListener {
 	...
 	private JMenuItem nu, open, save, saveas, exit, copy, paste, clear, sall, print, printpreview, about, b8, b14, b18, b25, b30, bb, br, bge, bgb, fb, fr, fge , fgd;

 	final static String LOOKANDFEEL = null;

 	public notepad() {
 		setLocation(200, 200);
 		setTitle("NOTEPAD PROJECT BY PRINCE SHARMA");
		 ...
		 fgd = new JMenuItem("White");
 		fgd.addActionListener(this);
 		fg.add(fgd);
 	...
 	public void actionPerformed(ActionEvent e) {
 		if (e.getSource() == nu) {
 			int nuask = JOptionPane.showConfirmDialog(notepad.this,"Are you sure? This will make a erase any unsaved documents!");
        ...
        //     }
 		...
 		if (e.getSource() == about) {
 			JOptionPane.showMessageDialog(null, "Created by:- Prince Sharma \n Contact for any Exception faced", "", JOptionPane.INFORMATION_MESSAGE);
 		}
 		if (e.getSource() == bb) {
